...
_G.packer_plugins = {
  ...
  ["vim-prosession"] = {
    ...
    url = "https://github.com/KohlJary/vim-prosession"
  },
  ["vim-signature"] = {
    loaded = true,
